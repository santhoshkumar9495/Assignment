...
const getProducts = async () => {
  let singledata = await axios.get(`https://64a67bae096b3f0fcc7fddb1.mockapi.io/students/${id}`)
  setSolution(singledata.data);
      ...
      const getdata = async () => {
        try {
          let listdata = await axios.get("https://64a67bae096b3f0fcc7fddb1.mockapi.io/mentors");
  ...
  const formik = useFormik({
    ...
    onSubmit : async values => {
        ...
        if(id){
          try {
            await axios.put(`https://64a67bae096b3f0fcc7fddb1.mockapi.io/students/${id}`, values)
